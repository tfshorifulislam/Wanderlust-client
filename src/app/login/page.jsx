        ...
        <div className="min-h-screen bg-[#f0f4f8] flex items-center justify-center p-6">
            <div className="w-full max-w-2xl bg-white border border-gray-200 rounded-2xl shadow-sm p-10">
                ...
                <div className="text-center mt-8">
                    ...
                    <button onClick={handleGoogle} className="w-full border cursor-pointer border-gray-200 hover:bg-gray-50 py-3.5 rounded-sm flex items-center justify-center gap-3 transition-colors">
